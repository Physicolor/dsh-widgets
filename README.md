...
- 🗂️ **Config preview uses free space.** The selected widget's preview now fills the remaining panel height (vertical centring turns extra room into padding), and the preview size control moved into the custom area under its own **卡片大小** heading (segmented 2×2 / 2×4 buttons, no dropdown).
