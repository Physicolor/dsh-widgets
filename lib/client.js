		...
		*/
		...
		function MarketTab({ controller, usageData }) {
			...
			if (previewGroup !== null) {
				...
				return react.createElement("div", { style: {
					...
					fontWeight: 600,
					color: "var(--dsw-alias-label-primary)"
				} }, w ? w.name : ""), w && sz.length > 1 ? react.createElement("div", { style: {
					display: "flex",
					alignItems: "center",
					gap: 2,
					flex: "none"
					...
					"aria-label": "更小尺寸",
					onClick: prevSize
				}, react.createElement(ChevronLeftIcon)), react.createElement("span", { style: {
					fontSize: 12,
					color: "var(--dsw-alias-label-secondary)",
					width: 40,
					textAlign: "center",
					fontVariantNumeric: "tabular-nums"
				} }, curSize === "2x4" ? "2×4" : "2×2"), react.createElement("button", {
					type: "button",
					className: "dsx-navbtn",
					"aria-label": "更大尺寸",
					onClick: nextSize
				}, react.createElement(ChevronRightIcon))) : null, react.createElement("button", {
					type: "button",
			...
			return react.createElement("div", { style: {
				...
				}, react.createElement("span", { className: "dsx-mhead" }, react.createElement("span", { className: "dsx-mname" }, GROUP_LABELS[groupOf(w)] ?? w.name), react.createElement("span", { className: "dsx-badge" }, String(gw.length))), react.createElement("span", { className: "dsx-mdesc" }, w.desc), react.createElement("span", { className: "dsx-macts" }, react.createElement("span", { className: "dsx-btn" }, "查看详情"), react.createElement("span", { className: anyInstalled ? "dsx-btn dsx-btn-primary" : "dsx-btn" }, anyInstalled ? "已添加" : "添加")));
			})));
		}
		...
		function SettingsPanel({ controller }) {
			...
			return react.createElement("div", { style: {
				...
				title: "隐藏输入框下方文字条",
				desc: "隐藏输入框下方的官方统计文字条（轮次/LLM 时长等）；组件栏中可查看同类信息，纯属个人偏好",
				children: react.createElement("label", { className: "dsx-switch-row" }, react.createElement("input", {
					type: "checkbox",
					className: "dsx-switch-input",
