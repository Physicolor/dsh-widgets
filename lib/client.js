		...
		function MarketTab({ controller, usageData }) {
			...
			if (previewGroup !== null) {
				...
				return react.createElement("div", { style: {
					...
					onClick: add
				}, installed ? "已添加" : "添加")), !installed && prefs.installed.length >= prefs.maxWidgets ? react.createElement("div", { style: {
					fontSize: 12,
					color: "var(--dsw-alias-state-warn-primary, var(--dsw-alias-label-tertiary))",
					marginTop: -4
				} }, `已达上限 ${prefs.maxWidgets} 个，先在组件配置中移除再添加`) : null, react.createElement("div", { style: {
					flex: 1,
					minHeight: 0,
					display: "flex",
					alignItems: "center",
			...
			return react.createElement("div", { style: {
				...
				}, react.createElement("span", { className: "dsx-mhead" }, react.createElement("span", { className: "dsx-mname" }, w.name), react.createElement("span", { className: "dsx-badge" }, GROUP_LABELS[groupOf(w)] ?? badgeOf(w))), react.createElement("span", { className: "dsx-mdesc" }, w.desc), react.createElement("code", { className: "dsx-mid" }, w.id), react.createElement("span", { className: "dsx-macts" }, react.createElement("span", { className: "dsx-btn" }, "查看详情"), react.createElement("span", { className: anyInstalled ? "dsx-btn dsx-btn-primary" : "dsx-btn" }, anyInstalled ? "已添加" : "添加")));
			})));
		}
